...
class KegiatanNonProgramPage extends StatefulWidget {
  const KegiatanNonProgramPage({super.key});

  @override
  _KegiatanNonProgramPageState createState() => _KegiatanNonProgramPageState();
}

class _KegiatanNonProgramPageState extends State<KegiatanNonProgramPage> {
    ...
    try {
      ...
      if (response.data is Map<String, dynamic> &&
        ...
        setState(() {
          ...
          filteredData = filterKegiatanByKategori(allData, 2);
        });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kegiatan Non-Program'),
