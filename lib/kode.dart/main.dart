...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> _pages = [
    ...
    Center(child: Text('Insight Page')), // Placeholder untuk halaman Insight
  ];
          ...
          children: [
            ...
            Positioned(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    backgroundImage: AssetImage('assets/dashboard.jpeg'),
                    radius: 40,
                  ),
                  SizedBox(width: 16),
                  Column(
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          SDMActivityDetailPage()), // Navigate to SDM Activity Detail Page
                );
              },
              child: ActivityDetailCard(
                title: "SDM",
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/kegiatan.png', // Replace with your image asset
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/kegiatan.png', // Image for SDM activity
                height: 180,
                width: double.infinity,
                fit: BoxFit.cover,
              ),
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => NonProgramActivityDetailPage()),
                );
              },
              child: ActivityDetailCard(
                ...
                statusColor: Colors.green,
                buttonColor: Colors.blue,
                imageUrl: 'assets/kegiatan.png', // Replace with your image
              ),
            ),
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(12),
              child: Image.asset(
                'assets/kegiatan.png', // Replace with your image for Non Program activity
                height: 180,
                width: double.infinity,
                fit: BoxFit.cover,
              ),
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => NonJTIActivityDetailPage()),
                );
              },
              child: ActivityDetailCard(
                ...
                points: 8,
                status: "Approve",
                details: ["Anggota (2 Pts)", "AA (3 Pts)", "< 7 Hari (3 Pts)"],
                buttonText: "Edit",
                statusColor: Colors.green,
                buttonColor: Colors.blue,
                imageUrl: 'assets/kegiatan.png', // Replace with your image
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(12),
              child: Image.asset(
                'assets/kegiatan.png', // Replace with your image for Non JTI activity
                height: 180,
                width: double.infinity,
                fit: BoxFit.cover,
              ),
