...
class KegiatanTerprogramPage extends StatefulWidget {
  const KegiatanTerprogramPage({super.key});

  @override
  _KegiatanTerprogramPageState createState() => _KegiatanTerprogramPageState();
}

class _KegiatanTerprogramPageState extends State<KegiatanTerprogramPage> {
    ...
    try {
      ...
      if (response.data is Map<String, dynamic> &&
        ...
        setState(() {
          ...
          filteredData =
              filterKegiatanByKategori(allData, 1); // Misalnya kategori_id 1
        });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kegiatan Terprogram'),
